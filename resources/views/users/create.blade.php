      ...
      <div class="col-12">
        ...
        <form class="form-group" action="{{route('utenti.store') }}" method="post">
          ...
          <div class="form-group">
            ...
            <input type="text" name="name" class="form-control" placeholder="Inserisci il nome utente">
          </div>
          <div class="form-group">
            <label for="lastname">Cognome</label>
            <input type="text" name="lastname" class="form-control" placeholder="Inserisci il cognome utente">
          </div>
          <div class="form-group">
